...
var cartReducer = function cartReducer() {
  ...
  switch (action.type) {
    case _cartConstant.CART_ADD_ITEM:
    ...
    case _cartConstant.CART_REMOVE_ITEM:
      return _objectSpread({}, state, {
    ...
    case _cartConstant.CART_SAVE_SHIPPING_ADDRESS:
      return _objectSpread({}, state, {
        shippingAddress: action.payload
      });

    case _cartConstant.CART_SAVE_PAYMENT_METHOD:
      return _objectSpread({}, state, {
