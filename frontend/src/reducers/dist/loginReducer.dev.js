...
var userLoginReducer = function userLoginReducer() {
  ...
  switch (action.type) {
    case _userConstant.USER_LOGIN_REQUEST:
      return {
        loading: true
      };

    case _userConstant.USER_LOGIN_SUCCESS:
      return {
        loading: false,
        userInfo: action.payload
      };

    case _userConstant.USER_LOGIN_FAIL:
      return {
        loading: false,
        error: action.payload
      };

    case _userConstant.USER_LOGOUT:
      return {
        userInfo: ''
      };
...
var userRegisterReducer = function userRegisterReducer() {
  ...
  switch (action.type) {
    case _userConstant.USER_REGISTER_REQUEST:
      return {
        loading: true
      };

    case _userConstant.USER_REGISTER_SUCCESS:
      return {
        loading: false,
        userInfo: action.payload
      };

    case _userConstant.USER_REGISTER_FAIL:
      return {
        loading: false,
        error: action.payload
      };
...
var userDetailsReducer = function userDetailsReducer() {
  ...
  switch (action.type) {
    case _userConstant.USER_DETAILS_REQUEST:
      return _objectSpread({}, state, {
        loading: true
      });

    case _userConstant.USER_DETAILS_SUCCESS:
      return {
        loading: false,
        user: action.payload
      };

    case _userConstant.USER_DETAILS_FAIL:
      return {
        loading: false,
        error: action.payload
      };

    case _userConstant.USER_DETAILS_RESET:
      return {
        user: {}
      };
...
var userUpdateProfileReducer = function userUpdateProfileReducer() {
  ...
  switch (action.type) {
    case _userConstant.USER_UPDATE_PROFILE_REQUEST:
      return {
        loading: true
      };

    case _userConstant.USER_UPDATE_PROFILE_SUCCESS:
      return {
        loading: false,
        success: true,
        userInfo: action.payload
    ...
    case _userConstant.USER_UPDATE_PROFILE_FAIL:
      return {
        loading: false,
        error: action.payload
      };
...
var userListReducer = function userListReducer() {
  ...
  switch (action.type) {
    case _userConstant.USER_LIST_REQUEST:
      return {
        loading: true
      };

    case _userConstant.USER_LIST_SUCCESS:
      return {
        loading: false,
        success: true,
    ...
    case _userConstant.USER_LIST_FAIL:
      return {
        loading: false,
        error: action.payload
      };

    case _userConstant.USER_LIST_RESET:
      return {
        users: []
      };
...
var userDeleteReducer = function userDeleteReducer() {
  ...
  switch (action.type) {
    case _userConstant.USER_DELETE_REQUEST:
      return {
        loading: true
      };

    case _userConstant.USER_DELETE_SUCCESS:
      return {
        loading: false,
        success: true
      };

    case _userConstant.USER_DELETE_FAIL:
      return {
        loading: false,
        error: action.payload
      };
...
var userUpdateReducer = function userUpdateReducer() {
  ...
  switch (action.type) {
    case _userConstant.USER_UPDATE_REQUEST:
      return {
        loading: true
      };

    case _userConstant.USER_UPDATE_SUCCESS:
      return {
        loading: false,
        success: true
      };

    case _userConstant.USER_UPDATE_FAIL:
      return {
        loading: false,
        error: action.payload
      };
